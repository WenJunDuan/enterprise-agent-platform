...
stage: "impl" # D1 GO 生效(2026-07-15 用户拍板 OCR 分层方案 i,design 定稿含连带修订)——impl TDD T1-T5,每 T commit+pytest 绿;黄区 generator 执行;D2-D11 仍 pending
