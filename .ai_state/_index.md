...
stage: "review"                   # item3 contract-audit-api：impl 全 done(283 passed)；下一门禁=铁律[Review强制]交叉审查(Feature+；纯镜像可轻量，需用户授权 spawn)
...
# === PACE 联动字段 (hook 自动维护) ===
next_action: "review:contract-audit-api:cross-review-gate"
