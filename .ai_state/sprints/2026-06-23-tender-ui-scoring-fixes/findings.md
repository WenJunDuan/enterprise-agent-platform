# 张謇 dogfood 诊断 + UI/评分问题拆分（2026-06-23）

> 触发：用户给 8 条实测问题 + 用 `knowledge/external/张謇企业家学院/`（招标 .doc 534KB + 新和投标 .PDF 43MB，单投标人）做测试。
...
## 三模型评标结果（张謇新和，项目 JSZC-320600-SXSD-G2025-0019，政府采购=state_funded）
